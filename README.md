...
* Default source extension set to `.C`
* Preconfigured compiler and library paths
...
* Supports traditional Turbo C++ headers such as `conio.h`, `dos.h`, and `graphics.h`.
* If a program enters an infinite loop and becomes unresponsive, simply close and reopen the application.
...
- [vDosPlus](http://www.vdosplus.org/) by Wengier Wu
